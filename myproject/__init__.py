...
def main(global_config, **settings):
    ...
    config.add_tween('myproject.auth.authenticator')
    ...
    add_admin_handler(config, DBSession, get_models(myproject), 'admin.', '/admin', AdminController)
...
def configure_app_routes(config):
    ...
    for app_name in enabled_apps:
        ...
        app_module = importlib.import_module(".apps.%s" % app_name, "myproject")
