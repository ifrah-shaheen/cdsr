...
<%def name="header()">
  <div id="top" style="text-align: center">
    <br /><br />
    <img src="${request.static_url('myproject:static/logo-cdsr.png')}"  alt="pyck"/>
  </div>
</%def>
        ...
        <div class="loginbox_inner">
            ...
            <div class="loginbox_content">
				...
				<div id="btn-box">
					...
					<a name="SignUp" href="${request.route_url('user_register')}" class="btn-aqua">SignUp</a>
				</div>
				<div id="btn-img-box">
                	<img src="${request.static_url('myproject:static/plane.png')}" class="spacer72" alt="icon-signin" id="icon-plane"/>
					<img src="${request.static_url('myproject:static/refresh.png')}"   class="spacer72 " alt="icon-signin" id="icon-refresh"/>
					<img src="${request.static_url('myproject:static/plus.png')}"   alt="icon-signin" id="icon-plus"/>
				</div>
            </div>
            </form>
        </div>
